...
## 🔖 Commit Message Strategy for hexaWebShare

To ensure consistent and readable commit messages across the project, **hexaWebShare** enforces the use of a standardized commit format and a predefined set of commit types.
